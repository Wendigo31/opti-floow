      ...
      const response = await fetch(`${import.meta.env.VITE_SUPABASE_URL}/functions/v1/ai-optimize-trip`, {
        ...
        body: JSON.stringify({
          ...
          montageOptions: {
            ...
            routePriority,
            maxTollBudget: maxTollBudget ? parseFloat(maxTollBudget) : undefined,
            avoidUrbanZones,
            ...
            allowNightDriving,
            allowWeekendDriving,
            vehicleHeight: parseFloat(vehicleHeight) || undefined,
            vehicleWeight: parseFloat(vehicleWeight) || undefined,
          },
          vehicleCosts: {
