...
export function ToxicClientsAnalysis() {
  ...
  if (clientAnalyses.length === 0) {
    return (
      <div className="text-center py-12 text-muted-foreground">
        ...
        <p className="font-medium">Aucune donnée d'analyse disponible</p>
        <p className="text-sm">Créez des tournées avec revenus pour vos clients pour voir l'analyse de rentabilité</p>
      </div>
    );
  }
          ...
          <CardContent>
            <div className="grid grid-cols-2 gap-3">
              <div className="p-3 bg-success/10 rounded-lg">
                <p className="text-xs text-muted-foreground">Rentables - €/h</p>
              ...
              <div className="p-3 bg-warning/10 rounded-lg">
                <p className="text-xs text-muted-foreground">Neutres - €/h</p>
              ...
              <div className="p-3 bg-destructive/10 rounded-lg">
                <p className="text-xs text-muted-foreground">Toxiques - €/h</p>
      ...
      <Card className="glass-card">
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle className="flex items-center gap-2">
            ...
            Classement ({filteredClients.length} clients)
          </CardTitle>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border">
                  ...
                  <th className="text-right py-3 px-4 text-sm font-medium text-muted-foreground">€/h</th>
