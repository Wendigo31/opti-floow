...
import { OptiPlanAccountsManager } from '@/components/team/OptiPlanAccountsManager';
import { useTeam } from '@/hooks/useTeam';
import { useLicense } from '@/hooks/useLicense';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/tabs';
import { Users, Settings, UserCog, Shield, Truck } from 'lucide-react';
      ...
      {isDirection ? (
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="grid w-full grid-cols-5">
            ...
            <TabsTrigger value="optiplan" className="flex items-center gap-2">
              <Truck className="h-4 w-4" />
              <span className="hidden sm:inline">OptiPlan</span>
            </TabsTrigger>
          ...
          <TabsContent value="optiplan">
            <OptiPlanAccountsManager />
          </TabsContent>
